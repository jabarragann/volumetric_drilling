...
def main(args):
    ...
    rospy.Timer(
        rospy.Duration(0, 500000), timer_callback
    )  # set to 2Khz such that we don't miss pose data
...
if __name__ == "__main__":
    ...
    parser.add_argument("--world_adf", default="../ADF/world/world.yaml", type=str)
    parser.add_argument("--volume_adf", default="../ADF/volume_171.yaml", type=str)
    parser.add_argument("--stereo_adf", default="../ADF/stereo_cameras.yaml", type=str)
    parser.add_argument("--nrrd_header", default="../resources/volumes/nrrd_header.pkl", type=str)
